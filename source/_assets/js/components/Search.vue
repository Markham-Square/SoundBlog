<template>
    <div class="flex flex-1 justify-end items-center text-right px-4">
        <div
            class="absolute md:relative w-full justify-end left-0 top-0 z-10 mt-7 md:mt-0 px-4 md:px-0 bg-white lg:bg-transparent"
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 border border-gray-300 focus:border-blue-400 outline-none cursor-pointer text-gray-700 px-4 pb-0 pt-px"
